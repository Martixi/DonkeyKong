...
int main(int argc, char **args) {
	...
	while (!quit) {
		...
		if (player.speed.x != 0){ walking = true; standing = false;}
		else {walking = false; standing = true;}
...
//		DrawRectangle(screen, platforms[0].x, platforms[0].y, platforms[0].w, platforms[0].h, cyan, cyan);
//		DrawRectangle(screen, platforms[1].x, platforms[1].y, platforms[1].w, platforms[1].h, cyan, cyan);
//		DrawRectangle(screen, platforms[2].x, platforms[2].y, platforms[2].w, platforms[2].h, cyan, cyan);
//		DrawRectangle(screen, platforms[3].x, platforms[3].y, platforms[3].w, platforms[3].h, cyan, cyan);
//		DrawRectangle(screen, platforms[4].x, platforms[4].y, platforms[4].w, platforms[4].h, cyan, cyan);
//		DrawRectangle(screen, platforms[5].x, platforms[5].y, platforms[5].w, platforms[5].h, cyan, cyan);
//		DrawRectangle(screen, ladders[0].x, ladders[0].y, ladders[0].w, ladders[0].h, red, red);
//		DrawRectangle(screen, ladders[1].x, ladders[1].y, ladders[1].w, ladders[1].h, red, red);
//		DrawRectangle(screen, ladders[2].x, ladders[2].y, ladders[2].w, ladders[2].h, red, red);
//		DrawRectangle(screen, ladders[3].x, ladders[3].y, ladders[3].w, ladders[3].h, red, red);
//		DrawRectangle(screen, ladders[4].x, ladders[4].y, ladders[4].w, ladders[4].h, red, red);
//		DrawRectangle(screen, ladders[5].x, ladders[5].y, ladders[5].w, ladders[5].h, red, red);
//		DrawRectangle(screen, ladders[6].x, ladders[6].y, ladders[6].w, ladders[6].h, red, red);
//		DrawRectangle(screen, ladders[7].x, ladders[7].y, ladders[7].w, ladders[7].h, red, red);
//		DrawRectangle(screen, ladders[8].x, ladders[8].y, ladders[8].w, ladders[8].h, red, red);
		...
		while (SDL_PollEvent(&event)) {
			...
			switch (event.type) {
				case SDL_KEYDOWN:
					...
					else if (event.key.keysym.sym == SDLK_UP and onLadder and canClimb){ moveValue = -LADDER_SPEED; isClimbing = true;}
					else if (event.key.keysym.sym == SDLK_DOWN and onLadder and canClimb){ moveValue = LADDER_SPEED; isClimbing = true;}
					else if (event.key.keysym.sym == SDLK_SPACE and jump == false and onLadder == false){ jump = true; jumpValue = -0.4;}
					break;
				case SDL_KEYUP:
					if (event.key.keysym.sym == SDLK_UP or event.key.keysym.sym == SDLK_DOWN ){
						if (onLadder == false and OnFloor(player, platforms)) moveValue = 0;
					}
